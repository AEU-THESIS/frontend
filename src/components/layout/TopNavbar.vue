...
<template>
  ...
  >
    ...
    <div class="flex items-center gap-3">
      ...
      <div
        class="w-8 h-8 rounded-full bg-stone-200 dark:bg-stone-700 overflow-hidden ml-2 cursor-pointer ring-2 ring-transparent hover:ring-amber-700 transition-all"
      >
        <img
