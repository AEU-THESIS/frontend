...
<template>
  ...
  >
    ...
    >
      <Card
        class="w-full max-w-[520px] gap-0 overflow-hidden rounded-2xl border-none bg-white p-0 shadow-xl dark:border dark:border-stone-800 dark:bg-stone-900"
      >
        <header
        ...
        <footer
          class="flex justify-end gap-3 border-t border-slate-100 bg-[#FAFAFA] px-6 py-4 dark:border-stone-800 dark:bg-stone-950/60"
        >
          <Button
            variant="tertiary"
